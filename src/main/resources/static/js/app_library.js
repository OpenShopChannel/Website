        ...
        rows: [
            {
                ...
                tooltip: function (obj) {
                    return "<i class='fas fa-calendar-alt fa-fw' aria-hidden='true' style='margin-right: .25em'></i>"
                        ...
                        "<i class='fas fa-sd-card fa-fw' aria-hidden='true' style='margin-right: .25em'></i>" + file_size(obj.uncompressed_size) + " (Extracted)<br>" +
                        "<i class='fas fa-wrench fa-fw' aria-hidden='true' style='margin-right: .25em'></i>Version " + obj.version;
                },
                template: function (obj) {
                    return "<a href='/library/app/" + obj.slug + "' style='color:inherit;'><div style='line-height:35px; height:42px; white-space:nowrap; overflow:hidden;'>" +
                        ...
                        "<img src='" + obj.assets.icon.url + "' style='height: 48px'></div>" +
                        "<div><div>" + obj.description.short + "<br>By " + obj.author + "<br></div></div></a>";
                },
                on: {
